    ...
    <>
      <div className="md:flex justify-start items-center md:gap-1 lg:gap-10 w-full lg:w-[860px]">
        <div className="py-10 px-6 w-96">
          ...
          <p className="text-xs leading-4 text-gray-800">In a world where luxury real estate is synonymous with innovation, quality, and unparalleled service, Highbridge Luxury stands out as a beacon of excellence.
          <br />
          <br />
          At Highbridge Luxury, we believe in the power of collaboration and the importance of understanding our clients' unique needs and aspirations. We are not just in the business of building structures; we are in the business of building dreams.
          <br /><br />
